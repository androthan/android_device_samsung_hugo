...
1. Add the following lines to <source_path>/.repo/manifest.xml
  <project name="androthan/android_device_samsung_hugo" path="device/samsung/hugo" remote="github" revision="cm-7.2" />
  <project name="androthan/android_vendor_samsung_hugo" path="vendor/samsung/hugo" remote="github" revision="cm-7.2" />
